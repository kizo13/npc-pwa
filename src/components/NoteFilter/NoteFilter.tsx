...
const NoteFilter = ({ onFilter }: NoteFilterProps): JSX.Element => {
    ...
    >
      ...
      <Card elevation={0} className={classes.filterCard}>
        <CardContent className={classes.filterMainBlock}>
          ...
          {/* UPLOADER */}
          <FormControl className={classes.filterFormControl}>
            <InputLabel id="notefilter-uploader-label">{t('common.labels.uploader')}</InputLabel>
            <Select
              labelId="notefilter-uploader-label"
              id="notefilter-uploader"
              open={openUsers}
          ...
          {/* CLASSES */}
          <FormControl className={classes.filterFormControl}>
            <InputLabel id="notefilter-class-label">{t('common.labels.class')}</InputLabel>
            <Select
              labelId="notefilter-class-label"
              id="notefilter-class"
              open={openClasses}
          ...
          {/* AGE */}
          <FormControl className={classes.filterFormControl}>
            <InputLabel id="notefilter-age-label">{t('common.labels.age')}</InputLabel>
            <Select
              labelId="notefilter-age-label"
              id="notefilter-age"
              value={filter.age}
          ...
          {/* RACE */}
          <FormControl className={classes.filterFormControl}>
            <InputLabel id="notefilter-race-label">{t('common.labels.race')}</InputLabel>
            <Select
              labelId="notefilter-race-label"
              id="notefilter-race"
              value={filter.race}
          ...
          {/* CULTURE */}
          <FormControl className={classes.filterFormControl}>
            <InputLabel id="notefilter-culture-label">{t('common.labels.culture')}</InputLabel>
            <Select
              labelId="notefilter-culture-label"
              id="notefilter-culture"
